    ...
    <main className="min-h-screen bg-[#08080F]">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-28 pb-16">
              ...
              {myStreams.map((e) => {
                ...
                return (
                  <Link
                    ...
                    href={`/app/stream/${id}`}
                    className="flex items-center justify-between p-4 rounded-xl border border-[#1A1A2E] bg-[#0F0F1A] hover:border-[#7C3AED] transition-colors"
                  >
                    <div>
        ...
        {myStreams.length === 0 && myPacts.length === 0 && (
          <div className="p-6 rounded-xl border border-[#1A1A2E] bg-[#0F0F1A] text-center">
            <p className="text-sm text-[#6B7280]">No activity yet. Create a stream or pact to get started.</p>
          </div>
        )}

        <div className="p-4 rounded-xl border border-[#1A1A2E] bg-[#0F0F1A] mt-4">
